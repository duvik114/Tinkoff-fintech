...
public class Lesson4Application {
    ...
    ApplicationRunner applicationRunner(StudentService studentService, CourseService courseService) {
        return args -> {
            //create our course
            Course course1 = new Course(1, "Java", "Fintech Java");
            Course course2 = new Course(2, "C/C++", "Skakov)");
            ...
            Student john = new Student(UUID.randomUUID(), "John", 27, course1.getId());
            ...
            Student mary = new Student(UUID.randomUUID(), "Mary", 19, course1.getId());
            studentService.save(mary);

            studentService.update(new Student(mary.getId(), "sus", 19, course2.getId()));
            studentService.save(john);

            //oldest Course test
            Student biba = new Student(UUID.randomUUID(), "biba", 19, course1.getId());
            Student boba = new Student(UUID.randomUUID(), "boba", 20, course2.getId());
            ...
            //Index test
            Course course3 = new Course(3, "puk", "chik");
            Course course4 = new Course(4, "lol", "kek");
            ...
            for (int i = 0; i < 100000; i++) {
                ...
                studentService.save(
                        new Student(UUID.randomUUID(), "name " + i, (100000 - i) % 10000, course.getId()));
            }
