...
import ru.tinkoff.fintech.lesson4.validation.StudentsToCourseMapperConstraint;
...
public class StudentController {
    ...
    public void addStudentsToCourse(@RequestBody @Valid @StudentsToCourseMapperConstraint StudentsToCourseMapper mapper) {
